...
HRAFNSYN_TRACK_POINT_RETENTION_DAYS=7
...
- `HRAFNSYN_TRACK_POINT_RETENTION_DAYS` keeps full-resolution points for this many days, then compacts older history to one last-seen point per track
