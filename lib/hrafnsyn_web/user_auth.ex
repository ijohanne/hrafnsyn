defmodule HrafnsynWeb.UserAuth do
  @moduledoc """
  Browser-session authentication helpers and plugs.
  """
  ...
  @remember_me_cookie "_hrafnsyn_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      HrafnsynWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
