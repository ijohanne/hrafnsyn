defmodule Hrafnsyn.GRPC.Helpers do
  ...
  def track_summary(track) do
    ...
    %Hrafnsyn.V1.TrackSummary{
      ...
      aircraft_type: summary_strings.aircraft_type,
      type_description: summary_strings.type_description,
      wake_turbulence_category: summary_strings.wake_turbulence_category,
    ...
    with {:ok, vehicle_type} <- vehicle_type_from_proto(observation.vehicle_type),
      ...
      {:ok,
       %{
         ...
         aircraft_type: blank_to_nil(observation.aircraft_type),
         type_description: blank_to_nil(observation.type_description),
         wake_turbulence_category: blank_to_nil(observation.wake_turbulence_category),
  ...
  defp summary_strings(track) do
    %{
      ...
      aircraft_type: or_empty(track.aircraft_type),
      type_description: or_empty(track.type_description),
      wake_turbulence_category: or_empty(track.wake_turbulence_category),
