...
defmodule Hrafnsyn.V1.TrackingIngress.Service do
  ...
  rpc :StreamObservations, stream(Hrafnsyn.V1.StreamObservationsRequest), stream(Hrafnsyn.V1.StreamObservationsResponse)
end
...
defmodule Hrafnsyn.V1.TrackingService.Service do
  ...
  rpc :ListActiveTracks, Hrafnsyn.V1.ListActiveTracksRequest, Hrafnsyn.V1.ListActiveTracksResponse
