defmodule Hrafnsyn.Accounts do
  @moduledoc """
  ...
  alias Hrafnsyn.Accounts.{User, UserNotifier, UserToken}
  alias Hrafnsyn.Repo
  ...
  def change_admin_user(user, attrs \\ %{}) do
  ...
  See `Hrafnsyn.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Hrafnsyn.Accounts.User.password_changeset/3` for a list of supported options.
